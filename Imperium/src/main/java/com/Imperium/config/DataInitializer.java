...
import com.Imperium.model.Funcoes; // modelo de função/role do usuário
import com.Imperium.model.Usuario; // modelo de usuário
import com.Imperium.repository.FuncoesRepository; // repositório para acessar funções no banco de dados
import com.Imperium.repository.UsuarioRepository; // repositório para acessar usuários no banco de dados
